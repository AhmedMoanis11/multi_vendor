  ...
  Widget _buildBody(BuildContext context) {
    return BlocConsumer<ResetPasswordCubit, ResetPasswordState>(
      listener: (context, state) {
        state.whenOrNull(
            success: (successMsg) =>
                showToast(successMsg, const Color.fromARGB(255, 14, 85, 1)),
            errors: (failureMsg) =>
                showToast(failureMsg, const Color.fromARGB(202, 135, 16, 0)));
      },
              ...
              CustomButtomAuth(
                  ...
                  onPressed: () {
                    BlocProvider.of<ResetPasswordCubit>(context).resetPassword(
                        UserEntity(
                            password: ResetPasswordCubit.rePassword.text,
                            email: ResetPasswordCubit.resetEmail));
                  }),
